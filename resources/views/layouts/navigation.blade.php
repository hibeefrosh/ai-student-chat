            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @auth
                        ...
                        <x-nav-link :href="route('admin.materials')" :active="request()->routeIs('admin.materials')">
                            {{ __('Manage Materials') }}
                        </x-nav-link>
                    @endauth
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                ...
                <x-responsive-nav-link :href="route('admin.materials')" :active="request()->routeIs('admin.materials')">
                    {{ __('Manage Materials') }}
                </x-responsive-nav-link>
            @endauth
        </div>
